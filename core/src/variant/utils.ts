 ...
 * ```
 */
export function parseVariantPath(path: string): ParsedVariantPath | null {
 ...
 * ```
 */
export function compareValues(a: unknown, b: unknown, _type?: IcebergPrimitiveType): number {
