 ...
 */
export async function readTableMetadata(storage, location) {
 ...
 */
export async function readMetadataFromPath(storage, metadataPath) {
 ...
 */
export function parseTableMetadata(json) {
    let parsed;
    try {
 ...
 */
export async function getCurrentVersion(storage, location) {
    // Validate location is a non-empty string
    if (typeof location !== 'string' || location.trim() === '') {
        throw new Error('Location must be a non-empty string');
    }
 ...
 */
export function getSnapshotAtTimestamp(metadata, timestampMs) {
 ...
 */
export function getSnapshotByRef(metadata, refName) {
 ...
 */
export function getSnapshotById(metadata, snapshotId) {
 ...
 */
export function getCurrentSnapshot(metadata) {
 ...
 */
export async function listMetadataFiles(storage, location) {
    // Validate location is a non-empty string
    if (typeof location !== 'string' || location.trim() === '') {
        throw new Error('Location must be a non-empty string');
    }
