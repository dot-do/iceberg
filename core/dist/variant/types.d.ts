 ...
 * ```
 */
export declare function createShreddedFieldInfo(columnName: string, fieldName: string, type: IcebergPrimitiveType, nullable?: boolean): ShreddedFieldInfo;
/**
 ...
 * ```
 */
export declare function createVariantColumnSchema(columnName: string, shreddedFields: readonly ShreddedFieldInfo[]): VariantColumnSchema;
/**
 ...
 * ```
 */
export declare function validateVariantShredConfig(config: VariantShredConfig): VariantShredConfigValidationResult;
/**
 ...
 */
export declare function getMetadataPath(columnName: string): string;
/**
 ...
 */
export declare function getValuePath(columnName: string): string;
/**
 ...
 */
export declare function getTypedValuePath(columnName: string, fieldName: string): string;
