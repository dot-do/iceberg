...
export { FORMAT_VERSION, FORMAT_VERSION_3, METADATA_DIR, VERSION_HINT_FILENAME, PARTITION_FIELD_ID_START, INITIAL_PARTITION_ID, POSITION_DELETE_FILE_PATH_FIELD_ID, POSITION_DELETE_POS_FIELD_ID, MANIFEST_ENTRY_STATUS_EXISTING, MANIFEST_ENTRY_STATUS_ADDED, MANIFEST_ENTRY_STATUS_DELETED, DEFAULT_SCHEMA_ID, DEFAULT_SPEC_ID, DEFAULT_SORT_ORDER_ID, POSITION_DELETE_SCHEMA_ID, EQUALITY_DELETE_SCHEMA_ID, MS_PER_DAY, MS_PER_HOUR, EPOCH_YEAR, } from './metadata/constants.js';
...
export { DeletionVector, serializeDeletionVector, deserializeDeletionVector, createDeletionVectorBlob, mergeDeletionVectors, DELETION_VECTOR_V1_BLOB_TYPE, type PuffinBlob, } from './deletes/deletion-vector.js';
export { upgradeTableToV3, upgradeTableToV3WithOptions, canUpgradeToV3, VersionUpgradeError, type VersionUpgradeErrorCode, type UpgradeOptions, } from './metadata/index.js';
export { validatePath, sanitizePath, isAbsolutePath, joinPaths, getParentPath, getBasename, } from './utils/index.js';
export type { ShreddedFieldInfo, VariantColumnSchema, VariantShredConfig, VariantShredConfigValidationResult, VariantShredPropertyConfig, ShredConfigValidationResult, VariantFilterColumnsResult, TransformResult, SerializedShreddedColumnStats, ShreddedColumnStats, // Deprecated alias for SerializedShreddedColumnStats
CreateShreddedStatsOptions, ColumnValues, CollectedStats, CollectedShreddedColumnStats, CollectStatsOptions, RangePredicate, FilterStats, PredicateResult, VariantShredConfigSimple, VariantSchemaField, SetupVariantShreddingOptions, SetupVariantShreddingResult, ConfigSchemaValidationResult, } from './variant/index.js';
export { createShreddedFieldInfo, createVariantColumnSchema, validateVariantShredConfig, getMetadataPath, getValuePath, getTypedValuePath, VARIANT_SHRED_COLUMNS_KEY, VARIANT_SHRED_FIELDS_KEY_PREFIX, VARIANT_SHRED_FIELDS_KEY_SUFFIX, VARIANT_FIELD_TYPES_KEY_SUFFIX, getShredFieldsKey, getFieldTypesKey, parseShredColumnsProperty, parseShredFieldsProperty, parseFieldTypesProperty, extractVariantShredConfig, formatShredColumnsProperty, formatShredFieldsProperty, formatFieldTypesProperty, toTableProperties, validateShredConfig, getStatisticsPaths, getColumnForFilterPath, mapFilterPathToStats, isVariantFilterPath, extractVariantFilterColumns, transformVariantFilter, isComparisonOperator, isLogicalOperator, getShreddedStatisticsPaths, assignShreddedFieldIds, serializeShreddedBound, deserializeShreddedBound, createShreddedColumnStats, applyShreddedStatsToDataFile, mergeShreddedStats, collectShreddedColumnStats, computeStringBounds, computeNumericBounds, computeTimestampBounds, computeBooleanBounds, addShreddedStatsToDataFile, createRangePredicate, evaluateRangePredicate, combinePredicatesAnd, combinePredicatesOr, filterDataFiles, filterDataFilesWithStats, shouldSkipDataFile, boundsOverlapValue, evaluateInPredicate, parseShredConfig, formatShredConfig, createVariantSchemaFields, getFieldIdForShreddedPath, validateConfigWithSchema, setupVariantShredding, } from './variant/index.js';
